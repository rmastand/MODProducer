...
# counters for what to write to stats2
	...
	if data_type == "Data":
		...
		w.write("#  Block"+format2_6("RunNum",22)+format2_6("LumiBlock",1180)+format2_6("Events",15)+format2_6("Valid?",15)+format2_6("IntLumiDel",15)+format2_6("IntLumiRec",15)+"\n")
		for lumi in sorted(sorted(lumi_info.keys(),key=lambda tup: tup[1]),key=lambda tup: tup[0]):
			try:
				w.write("   Block"+format2_6(str(lumi[0]),22)+format2_6(str(lumi[1]),18)+format2_6(str(lumi_info[lumi]["events"]),15)+format2_6(str(lumi_info[lumi]["valid"]),15)+format2_6("{0:.3f}".format(run_lumi_dict[lumi][0]),15)+format2_6("{0:.3f}".format(run_lumi_dict[lumi][1]),15)+"\n")
			except KeyError:
				w.write("   Block"+format2_6(str(lumi[0]),22)+format2_6(str(lumi[1]),18)+format2_6(str(lumi_info[lumi]["events"]),15)+format2_6(str(lumi_info[lumi]["valid"]),15)+format2_6("0.000",15)+format2_6("0.000",15)+"\n")
	if data_type == "Sim":
		...
		w.write("# SBlock"+format2_6("RunNum",15)+format2_6("LumiBlock",10)+format2_6("Events",10)+format2_6("Valid?",10)+format2_6("CrossSection",20)+"\n")
		for lumi in sorted(sorted(lumi_info.keys(),key=lambda tup: tup[1]),key=lambda tup: tup[0]):
			w.write("  SBlock"+format2_6(str(lumi[0]),15)+format2_6(str(lumi[1]),10)+format2_6(str(lumi_info[lumi]["events"]),10)+format2_6("1",10)+format2_6("{0:.3f}".format(float(cross_section)),35)+"\n")
