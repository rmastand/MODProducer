...
if setting == "event":
	...
	w.write(setw("Total",35)+setw(str(total_events[0]),n)+setw("1",n)+setw(str(total_events[1]),n)+setw(str(float(total_events[1])/float(total_events[0]))[:10],n)  +setw("N/A",n)+setw("N/A",n)+setw(str(total_luminosity),20)+setw("N/A",20)  + "\n") 
if setting == "lumi":
	...
	for trigger_name in valid_lumi_dict.keys():	
		w.write(setw(trigger_name,35)+setw(str(valid_lumi_dict[trigger_name][0]),n)+setw( "N/A",n)+setw(str(valid_lumi_dict[trigger_name][1] ),n)+setw( str(valid_lumi_dict[trigger_name][1]/valid_lumi_runA)[:10],n)  +setw(triggers_lumin_eff_dict[trigger_name][0],20)+setw(str(total_luminosity/float(triggers_lumin_eff_dict[trigger_name][0])),20)  + "\n") 
