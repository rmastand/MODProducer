...
for file in os.listdir(mod_file_dir):
	...
	if data_type == "Data":
		w.write("#        Trig"+format2_6("Name",40)+format2_6("Present",9)+format2_6("Valid",7)+format2_6("Fired",7)+format2_6("AvePrescale",14)+format2_6("EffLumiDel",13)+format2_6("EffLumiRec",15)+"\n")
