...
def logo_box():
        ...
        anchored_box = AnchoredOffsetbox(loc=1, child=logo_and_text_box, pad=0.2, frameon=False, borderpad=0., bbox_to_anchor=[0.104, .5], bbox_transform = plt.gcf().transFigure)
