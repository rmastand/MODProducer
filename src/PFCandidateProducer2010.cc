...
class PFCandidateProducer2010 : public EDProducer 
{
public: 
   explicit PFCandidateProducer2010(const ParameterSet&);
   ~PFCandidateProducer2010();
...
PFCandidateProducer2010::PFCandidateProducer2010(const ParameterSet& iConfig)
: hltConfig_(),
...
PFCandidateProducer2010::~PFCandidateProducer2010() {

}


std::string PFCandidateProducer2010::to_string ( int number ) {
...
void PFCandidateProducer2010::produce(Event& iEvent, const EventSetup& iSetup) {
...
void PFCandidateProducer2010::beginJob() {
   ...
   JetCorrectorParameters *AK5ResJetPar = new JetCorrectorParameters("data/JEC/GR_R/GR_R_42_V25_AK5PF_L2L3Residual.txt"); 
   JetCorrectorParameters *AK5L3JetPar  = new JetCorrectorParameters("data/JEC/GR_R/GR_R_42_V25_AK5PF_L3Absolute.txt");
   JetCorrectorParameters *AK5L2JetPar  = new JetCorrectorParameters("data/JEC/GR_R/GR_R_42_V25_AK5PF_L2Relative.txt");
   JetCorrectorParameters *AK5L1JetPar  = new JetCorrectorParameters("data/JEC/GR_R/GR_R_42_V25_AK5PF_L1FastJet.txt");
...
void PFCandidateProducer2010::endJob() {
   struct timeval tp2;
...
void PFCandidateProducer2010::beginRun(edm::Run & iRun, edm::EventSetup const & iSetup){
...
void PFCandidateProducer2010::endRun(edm::Run&, edm::EventSetup const&) {

}

void PFCandidateProducer2010::beginLuminosityBlock(edm::LuminosityBlock& iLumi, edm::EventSetup const& iSetup) {
   
}

void PFCandidateProducer2010::endLuminosityBlock(edm::LuminosityBlock& iLumi, edm::EventSetup const& iSetup) {

}

bool PFCandidateProducer2010::triggerFired(const std::string& triggerWildCard, const edm::TriggerResults& triggerResults) {
   bool fired = false;
...
unsigned int PFCandidateProducer2010::findTrigger(const std::string& triggerWildCard) {
...
bool PFCandidateProducer2010::file_exists(const std::string& name) {
  struct stat buffer;   
  return (stat (name.c_str(), &buffer) == 0); 
}

DEFINE_FWK_MODULE(PFCandidateProducer2010);
